...
import com.example.demo.orchestrator.pojo.sink.SinkAE;
import com.example.demo.orchestrator.pojo.source.SourceAE;
...
public class SimpleTestJob {
    ...
    public Step readFromOtherDb(ItemReader<SourceAE> itemReader,
        ...
        return new StepBuilder("readFromOtherDb", jobRepository)
